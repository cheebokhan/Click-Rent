...
export const UpgradeEmailReminder = () => {
  return <>

    <Box display="flex" justifyContent='center'>
     <Typography variant="h1">Auto Email Reminders</Typography>
    </Box>
    <Typography style={{
      textAlign:'center'
    }}>We can send auto reminder emails to your customers. To use this premium feature you need to upgrade to Professional account.</Typography>
