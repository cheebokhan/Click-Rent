            ...
            {({
              ...
              <form className={classes.form}>
                <>
                  ...
                  />
                  <a style={{ marginLeft: "170px",color:'gray' }} target="_blank" href="https://appmanager.impact-soft.com/register">
                    {getTranslation("Don't have a account? Sign up","Don't have a account? Sign up","Don't have a account? Sign up")}
                    </a>
