      ...
      <CardContent>
        ...
        <Grid container style={{marginBottom:"50px"}}>
          ...
          <Autocomplete
            ...
            options={filterBank}
            value={selectedBank}
            getOptionLabel={(option) => option.iban =="CR-All" || option.iban =="All"  || option.iban=="Tout" || option.iban=="Alle" ? option.iban : option.iban + " " + option.shortDescription}
            size="small"
            placeholder="Filter"
            onChange={(e, filter) => {
        ...
        <Grid container>
          ...
          <Grid item xs={8} sm={8} md={4} lg={3} style={{height:"30px"}}>
            <ToggleButtonGroup
