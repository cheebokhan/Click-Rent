...
const Details = ({ tenantId, loading, rows, onFilter }) => {
  ...
  }, [page, searchString, rowsPerPage, sort, sortDirection,tenantDetailStatus]);
  //handlers
      ...
      <Card>
        ...
        >
          ...
          <ToggleButton value={"warranty"} aria-label="centered">
            <Typography>{getTranslation("Warranty", "Warranty", "Warranty")}</Typography>
          </ToggleButton>
          <ToggleButton value={"maintenance"} aria-label="centered">
            <Typography>{getTranslation("Maintenance", "Maintenance", "Maintenance")}</Typography>
          </ToggleButton>
        </ToggleButtonGroup>
        <br />
        <CardContent>
