              ...
              <Grid container style={{ borderRight: '1px gray solid' }}>
                ...
                {activeContract ? <>
                  ...
                  <Grid item xs={3} sm={3} md={3}>
                    ...
                    <Typography className={classes.subtitle}>
                      {activeContract ? activeContract?.statusText.replace( "Occupied",getTranslation("Occupied","Occupied","Occupied"))
                        .replace( "Reserved",getTranslation("Reserved","Reserved","Reserved"))
                        .replace( "Available",getTranslation("Available","Available","Available"))
                        .replace( "On Notice",getTranslation("On Notice Period","On Notice Period","On Notice Period")) : null}
                    </Typography>
